...
if (process.env.NODE_ENV === 'production') {
  ...
  module.exports = {
    ...
    aws_region: process.env.aws_region || 'us-east-2',
    collection_schedules_queue_url:
      process.env.collection_schedules_queue_url || 'https://sqs.us-east-2.amazonaws.com/350152003452/CollectionSchedulesQueue',

    mifos_base_url:
      process.env.mifos_base_url || 'https://ec2-54-169-251-192.ap-southeast-1.compute.amazonaws.com/fineract-provider/api/v1/',
    mifos_user: process.env.mifos_user || 'mifos',
    mifos_password: process.env.mifos_password || 'password',
