...
function service(data){
	...
	.then(async (profile) => { 
       ...
       let permissions =  await models.sequelize.query(`
        ...
        let profile_token = await models.auth_token.findOne({ where: {user_id: globalUser.id, type: 'profile_token'}})
    ...
    .then(tokenObject => {
        ...
        d.resolve({profile_token: tokenObject.token});
    })
